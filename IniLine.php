...
$sql = "select num, date_format(recorded,'%d -> %T') as fecha, message, contenedor from datos ORDER BY NUM DESC LIMIT 10"; // Consulta SQL
...
<canvas id="chart1" width="125%" height="30%"></canvas>
<script>
