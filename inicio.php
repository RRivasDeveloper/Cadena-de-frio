    ...
    <div class="container-fluid">
      ...
      <div  class="navbar-collapse collapse" id="navbarsExample04" style="">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a style="color: #fff;" class="nav-link" href="pdf/reportes.php">Reportes</a>
            </li>
        </ul>
      </div>
      <div>
...
<h1  style="text-align: center;">Gráfica de camabios en temperatura</h1>
<canvas id="chart1" width="125%" height="20%"></canvas>
<script>
