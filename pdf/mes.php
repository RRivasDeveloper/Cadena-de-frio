    ...
    <div class="container-fluid">
      ...
      <div  class="navbar-collapse collapse" id="navbarsExample04" style="">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a style="color: #fff;" class="nav-link" href="mespdf.php?fecha=<?php echo "{$enteroMes}";?>">
   	        <input type="submit" name="enviar" value="Imprimir Mes" class="btn btn-primary"><BR>
            </a>
            </li>
        </ul>
      </div>
