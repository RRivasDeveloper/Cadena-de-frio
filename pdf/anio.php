...
$anio = $_POST["anio"]; 
$enteroAnio=intval("{$anio}");
//$enteroMes=intval("{$fechames[5]}{$fechames[6]}");//valor entero del mes
...
//$sql = " select num, date_format(recorded,'%d/%m/%y - %T') as fecha, message, contenedor from datos where MONTH(recorded)='{$enteroMes}';";//exito mes EXITO
$sql = " select num, date_format(recorded,'%d/%m/%y - %T') as fecha, message, contenedor from datos where YEAR(recorded)='{$enteroAnio}';"; //EXITO ANIO eXTO
...
<nav class="navbar navbar-expand-md" style="background-color: #3fa8b3;" aria-label="Fourth navbar example">
    <div class="container-fluid">
      <a style="color: #fff;font-size: 30px;" class="navbar-brand" href="../inicio.php"> <img src="../pdf/images/logo.jpg" alt="" width="100" height="80" >Tropical Sea Food</a>
      ...
      <div  class="navbar-collapse collapse" id="navbarsExample04" style="">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a style="color: #fff;" class="nav-link" href="aniopdf.php?anio=<?php echo "{$enteroAnio}";?>">
   	        <input type="submit" name="enviar" value="Imprimir Año" class="btn btn-primary"><BR>
            </a>
            </li>
        </ul>
      </div>
