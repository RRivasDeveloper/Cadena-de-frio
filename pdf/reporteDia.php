...
<H3 style="margin:0 auto;  text-align: center;">Consulta de Registros por Día </H3><BR>
<form  style="margin: auto; width: 220px;" nanme="mes" action="reporteDia.php" method="POST">
	<input type="date" name="fecha"  >
   	<input type="submit" name="enviar" value="Consultar Día" class="btn btn-primary"><BR>
</form>
<H3 style="margin:0 auto;  text-align: center;">Consulta de Registros por Mes </H3><BR>
<form  style="margin: auto; width: 220px;"  nanme="ejemplomonth" action="vfecha.php" method="POST">
	
    <input type="month" id="mes" name="mes">
    
	<input type="submit" name="enviar" value="Consultar Mes"  class="btn btn-primary"><BR>
</form>
<H3 style="margin:0 auto;  text-align: center;">Consulta de Registros por año </H3><BR>
<form  style="margin: auto; width: 220px;"  nanme="ejemplomonth" action="vfecha.php" method="POST">

    <input type="number" min="2022" max="2025" step="1" name="anio" id="anio" value="2022" >
    <br><!--EXITO-->
